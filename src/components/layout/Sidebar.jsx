        ...
        {openMenu ? (
          <div className="absolute left-4 right-4 top-[calc(100%-4px)] z-50 overflow-hidden rounded-[18px] border border-[var(--border-soft)] bg-white shadow-[0_18px_42px_rgba(16,24,40,0.14)]">
            ...
            >
              ...
              <span className="text-[#667085]">View</span>
            </button>

            <button
              type="button"
              onClick={() => toast.info('Change password is not connected yet')}
              className="flex w-full items-center justify-between border-t border-[var(--border-soft)] px-4 py-3 text-left text-sm text-[#101828] transition hover:bg-[#f4f6ee]"
            >
              <span className="flex items-center gap-3">
                <KeyIcon />
                <span>Change Password</span>
              </span>
              <span className="text-[#667085]">Edit</span>
            </button>
            ...
            >
              <span>Sign out</span>
              <span className="text-[#667085]">Exit</span>
            </button>
          </div>
        ) : null}
      </div>
