        ...
        {openMenu ? (
          <div className="absolute left-4 right-4 top-[calc(100%-4px)] z-50 overflow-hidden border border-[#ded7ef] bg-white shadow-[0_18px_42px_rgba(42,31,72,0.14)]">
            ...
            >
              ...
              <span className="text-[#8d7fa3]">View</span>
            </button>

            <button
              type="button"
              onClick={() => toast.info('Change password is not connected yet')}
              className="flex w-full items-center justify-between border-t border-[#eee9f8] px-4 py-3 text-left text-[13px] text-[#21192d] transition hover:bg-[#f5efff]"
            >
              <span className="flex items-center gap-3">
                <KeyIcon />
                <span>Change Password</span>
              </span>
              <span className="text-[#8d7fa3]">Edit</span>
            </button>
            ...
            >
              <span>Sign out</span>
              <span className="text-[#8d7fa3]">Exit</span>
            </button>
          </div>
        ) : null}
      </div>
        ...
        <div className="space-y-2">
          {homeItems.map((item) => {
            ...
            return (
              ...
              >
                <span className="flex items-center gap-3">
                  <span className={`flex h-6 w-6 items-center justify-center ${isItemActive(item) ? 'bg-[#c9f3de] text-[#0f7a48]' : 'bg-[#f8ddec] text-[#9f2d6a]'}`}>
                    <Icon />
                  </span>
          ...
          <div className="pt-1">
            ...
            >
              <span className="flex items-center gap-3">
                <span className={`flex h-6 w-6 items-center justify-center ${marketingOpen ? 'bg-[#c9f3de] text-[#0f7a48]' : 'bg-[#f8ddec] text-[#9f2d6a]'}`}>
                  <MarketingIcon />
                </span>
